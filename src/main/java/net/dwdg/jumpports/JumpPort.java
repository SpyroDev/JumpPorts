...
public class JumpPort {
    ...
    public final void load() {
        ...
        if (triggerSection.getBoolean("sneak", false)) {
            triggers.add(PortTrigger.SNEAK);
        }
        if (triggerSection.getBoolean("sprint", false)) {
            triggers.add(PortTrigger.SPRINT);
        }
        if (triggerSection.getBoolean("jump", false)) {
            triggers.add(PortTrigger.JUMP);
        }
        if (triggerSection.getBoolean("fall", false)) {
            triggers.add(PortTrigger.FALL);
        }
        if (triggerSection.getBoolean("fireArrow", false)) {
            triggers.add(PortTrigger.ARROW);
        }
        if (triggerSection.getBoolean("eggThrow", false)) {
            triggers.add(PortTrigger.EGG);
        }
